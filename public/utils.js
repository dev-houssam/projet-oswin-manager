function openWindow(newId=null, icons,title, content, x_=500, y_ = 300,  w_=400, h_=300) {
...
function updateAppList() {
    ...
    installedApps.forEach(app => {
        ...
        appItem.onclick = () => {
            ...
            const mutedString = app.content.replaceAll(`thread_`, `${newId}-`);
            openWindow(newId, app.icon, app.name, mutedString, app.x, app.y, app.width, app.height); // Ouvrir la fenêtre avec le contenu spécifique
